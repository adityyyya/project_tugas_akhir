...
<div id="pageSurat">
    ...
    <div class="col-lg-5 pb-4 mb-2" style="background: white; box-shadow: 2px 2px grey;">
        <form id="filterForm" method="get" action="">
            ...
            <button type="submit" class="btn btn-sm btn-success mt-2"><i class="fa fa-filter"></i> Tampilkan</button>
...
$(document).ready(function() {
    // Inisialisasi select2 untuk dropdown klasifikasi dan status surat
