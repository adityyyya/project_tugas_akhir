	...
	<div class="row">
		<div class="col-lg-3 text-center">
			...
			<ul class="list-unstyled user_data">
				<li><i class="fa fa-user user-profile-icon"></i> {{$dt->nip}}
				</li>

				<li>
					<i class="fa fa-briefcase user-profile-icon"></i> {{Auth::user()->level}}
				</li>
		...
		<div class="col-lg-9 ">
			<form id="profilForm" action="POST" enctype="multipart/form-data">
				@csrf
							...
							<div class="row">
								...
								<div class="col-6">
									<div class="form-group">
										...
										<input type="text" required="" value="{{$dt->email}}" autocomplete="off" class="form-control" id="email" name="email">
									</div>
								</div>
								<div class="col-6">
									<div class="form-group">
								...
								<div class="col-12">
									<div class="form-group">
										<input type="text" hidden="" value="{{$dt->foto}}" id="fotoLama" name="fotoLama">
